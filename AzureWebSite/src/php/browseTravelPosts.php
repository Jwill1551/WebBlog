<!--    
  ...
  browseTravelPosts.php: 
      This php script is used to browse all Travel posts in the posts sql table.
...
// query to get all Travel posts
$query = "SELECT * FROM postsDB WHERE CATEGORY = 'travel';";
...
<body>
  ...
  <div class="outer_posts_container">
    <div class="inner_posts_container inner_posts_container--travel">
      <?php 
