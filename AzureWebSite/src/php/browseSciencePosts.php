<!--    
  ...
  browseSciencePosts.php: 
      This php script is used to browse all Science posts in the posts sql table.
...
// query to get all Science posts
$query = "SELECT * FROM postsDB WHERE CATEGORY = 'science';";
...
<body>
  ...
  <div class="outer_posts_container">
    <div class="inner_posts_container inner_posts_container--science">
      <?php 
